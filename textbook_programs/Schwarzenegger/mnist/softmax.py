...
def main(_):
  ...
  print("-- A MNIST 30. tesztkepenek felismerese, mutatom a szamot, a tovabblepeshez csukd be az ablakat")
  ...
  print("-- A MNIST 12. tesztkepenek felismerese, mutatom a szamot, a tovabblepeshez csukd be az ablakat")
